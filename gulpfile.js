...
var icons = ['account', 'account-alert', 'account-card-details', 'account-box-outline', 'account-circle', 'account-multiple', 'account-multiple-outline',
    ...
    'chevron-down', 'chevron-left', 'chevron-right', 'chevron-up', 'cisco-webex', 'clipboard-account', 'clipboard-text', 'clock-alert',
    ...
    'file', 'file-account', 'file-chart', 'file-check', 'file-document-box', 'folder-account', 'format-list-bulleted', 'gauge', 'history', 'home',
    'information', 'information-outline', 'library', 'link', 'lock', 'lock-unlocked', 'logout', 'magnify', 'map-marker', 'more',
    'note', 'page-first', 'page-last', 'pencil', 'phone', 'plus', 'printer', 'remote', 'settings', 'sort-ascending', 'sort-descending', 'speedometer', 'swap-horizontal',
